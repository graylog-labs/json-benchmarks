...
public class SmallDeserializationBenchmark {
    @State(Scope.Thread)
    public static class BenchmarkState {
        private final URL resource = Resources.getResource("data/small.json");
    ...
    @Benchmark
    public void testGsonDeserializeSmallJson(BenchmarkState state, Blackhole bh) throws IOException {
    ...
    @Benchmark
    public void testJacksonDeserializeSmallJson(BenchmarkState state, Blackhole bh) throws IOException {
    ...
    @Benchmark
    public void testJacksonWithAfterburnerDeserializeSmallJson(BenchmarkState state, Blackhole bh) throws IOException {
        final TypeReference<Map<String, Object>> typeReference = new TypeReference<Map<String, Object>>() {
        };
